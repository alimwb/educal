                    ...
                    <div className="course__sidebar-widget-2 white-bg mb-20">
                        <div className="course__video">
                            ...
                            <div className="course__enroll-btn">
                                <Link href="/course-grid" className="e-btn e-btn-7 w-100">Enroll <i className="fas fa-arrow-right"></i></Link>
                            </div>
                        </div>
                    </div>
                    <div className="course__sidebar-widget-2 white-bg mb-20">
                        <div className="course__sidebar-course">
                            ...
                            <ul>
                                <li>
                                    <div className="course__sm d-flex align-items-center mb-30">
                                        <div className="course__sm-thumb mr-20">
                                            <Link href="/course-grid"><img src="assets/img/course/sm/course-sm-1.jpg" alt="img not found" /></Link>
                                        </div>
                                        <div className="course__sm-content">
                                            ...
                                            <h5><Link href="/course-grid">Development</Link></h5>
                                ...
                                <li>
                                    <div className="course__sm d-flex align-items-center mb-30">
                                        <div className="course__sm-thumb mr-20">
                                            <Link href="/course-grid"><img src="assets/img/course/sm/course-sm-2.jpg" alt="img not found" /></Link>
                                        </div>
                                        <div className="course__sm-content">
                                            <div className="course__sm-rating">
                                                <ul>
                                            ...
                                            <h5><Link href="/course-grid">Data Science</Link></h5>
                                            <div className="course__sm-price">
                                                <span>$72.00</span>
                                            </div>
                                        </div>
                                ...
                                <li>
                                    <div className="course__sm d-flex align-items-center mb-10">
                                        <div className="course__sm-thumb mr-20">
                                            <Link href="/course-grid"><img src="assets/img/course/sm/course-sm-3.jpg" alt="img not found" /></Link>
                                        </div>
                                        <div className="course__sm-content">
                                            <div className="course__sm-rating">
                                                <ul>
                                            ...
                                            <h5><Link href="/course-grid">UX Design</Link></h5>
                                            <div className="course__sm-price">
                                                <span>Free</span>
                                            </div>
                                        </div>
