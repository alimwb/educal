                        ...
                        <div className="row">
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div className="category__item mb-30 transition-3 d-flex align-items-center">
                                    ...
                                    <div className="category__content">
                                        <h4 className="category__title"><Link href="/course-details">Data Science</Link></h4>
                            ...
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div className="category__item mb-30 transition-3 d-flex align-items-center">
                                    ...
                                    <div className="category__content">
                                        <h4 className="category__title"><Link href="/course-details">Business</Link></h4>
                            ...
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div className="category__item mb-30 transition-3 d-flex align-items-center">
                                    ...
                                    <div className="category__content">
                                        <h4 className="category__title"><Link href="/course-details">Art & Design</Link></h4>
                                        <p>Fun & Challenging</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div className="category__item mb-30 transition-3 d-flex align-items-center">
                                    ...
                                    <div className="category__content">
                                        <h4 className="category__title"><Link href="/course-details">Lifestyle</Link></h4>
                            ...
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div className="category__item mb-30 transition-3 d-flex align-items-center">
                                    ...
                                    <div className="category__content">
                                        <h4 className="category__title"><Link href="/course-details">Marketing</Link></h4>
                                        <p>Improve your business</p>
                                    </div>
                                </div>
                            </div >
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div className="category__item mb-30 transition-3 d-flex align-items-center">
                                    ...
                                    <div className="category__content">
                                        <h4 className="category__title"><Link href="/course-details">Finance</Link></h4>
                                        <p>Fun & Challenging</p>
                                    </div>
                                </div>
                            </div >
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div className="category__item mb-30 transition-3 d-flex align-items-center">
                                    ...
                                    <div className="category__content">
                                        <h4 className="category__title"><Link href="/course-details">Health & Fitness</Link></h4>
                            ...
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div className="category__item mb-30 transition-3 d-flex align-items-center">
                                    ...
                                    <div className="category__content">
                                        <h4 className="category__title"><Link href="/course-details">Music</Link></h4>
                                        <p>Major or Minor</p>
                                    </div>
                                </div>
                            </div >
                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div className="category__item mb-30 transition-3 d-flex align-items-center">
                                    ...
                                    <div className="category__content">
                                        <h4 className="category__title"><Link href="/course-details">Academics</Link></h4>
