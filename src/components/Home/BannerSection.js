                                ...
                                <div className="banner__item p-relative mb-40" style={{ backgroundImage: `url(${'assets/img/banner/banner-bg-1.jpg'})` }}>
                                    <div className="banner__content">
                                        ...
                                        <h3 className="banner__title">
                                            <Link href="/course-details">Germany Foundation <br /> Document</Link>
                                        </h3>
                                        <Link href="/course-details" className="e-btn e-btn-2">View Courses</Link>
                                    </div>
                            ...
                            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                <div className="banner__item p-relative mb-40" style={{ backgroundImage: `url(${'assets/img/banner/banner-bg-2.jpg'})` }}>
                                    <div className="banner__content">
                                        ...
                                        <h3 className="banner__title">
                                            <Link href="/course-details">Online Courses <br />From Eduka University</Link>
                                        </h3>
                                        <Link href="/course-details" className="e-btn e-btn-2">Find Out More</Link>
                                    </div>
