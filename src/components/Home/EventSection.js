                                ...
                                <div className="events__item mb-10 hover__active">
                                    <div className="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                                        <div className="events__content">
                                            ...
                                            <h3 className="events__title"><Link href="/event-details">Digital transformation conference</Link></h3>
                                        </div>
                                ...
                                <div className="events__item mb-10 hover__active active">
                                    <div className="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                                        <div className="events__content">
                                            ...
                                            <h3 className="events__title"><Link href="/event-details">World education day conference</Link></h3>
                                        </div>
                                        <div className="events__more">
                                            <Link href="/event-details" className="link-btn">
                                                View More
                                ...
                                <div className="events__item mb-10 hover__active">
                                    <div className="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                                        <div className="events__content">
                                            ...
                                            <h3 className="events__title"><Link href="/event-details">Foundations of global health</Link></h3>
                                        </div>
                                        <div className="events__more">
                                            <Link href="/event-details" className="link-btn">
                                                View More
                                ...
                                <div className="events__item mb-10 hover__active">
                                    <div className="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                                        <div className="events__content">
                                            ...
                                            <h3 className="events__title"><Link href="/event-details">Business creativity workshops</Link></h3>
                                        </div>
                                        <div className="events__more">
                                            <Link href="/event-details" className="link-btn">
                                                View More
