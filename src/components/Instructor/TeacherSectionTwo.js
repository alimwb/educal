            ...
            <div className="container">
               ...
               <div className="row">
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                        <div className="teacher__thumb w-img fix">
                           <Link href="/instructor"><a><img src="assets/img/teacher/teacger-1.jpg" alt="img not found"/></a></Link>
                        </div>
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                        <div className="teacher__thumb w-img fix">
                           <Link href="/instructor"><a><img src="assets/img/teacher/teacher-2.jpg" alt="img not found"/></a></Link>
                        </div>
                        <div className="teacher__content">
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                        <div className="teacher__thumb w-img fix">
                           <Link href="/instructor"><a><img src="assets/img/teacher/teacher-3.jpg" alt="img not found"/></a></Link>
                        </div>
                        <div className="teacher__content">
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                        <div className="teacher__thumb w-img fix">
                           <Link href="/instructor"><a><img src="assets/img/teacher/teacher-5.jpg" alt="img not found"/></a></Link>
                        </div>
                        <div className="teacher__content">
                           <h3 className="teacher__title">Lillian Walsh,</h3> 
                           <span>CO Founder</span>
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                        <div className="teacher__thumb w-img fix">
                           <Link href="/instructor"><a><img src="assets/img/teacher/teacher-4.jpg" alt="img not found"/></a></Link>
                        </div>
                        <div className="teacher__content">
                  ...
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div className="teacher__item text-center grey-bg-5 transition-3 mb-30">
                        <div className="teacher__thumb w-img fix">
                           <Link href="/instructor"><a><img src="assets/img/teacher/teacher-6.jpg" alt="img not found"/></a></Link>
                        </div>
                        <div className="teacher__content">
