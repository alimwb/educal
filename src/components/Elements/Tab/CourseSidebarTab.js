                    ...
                    <TabPanel>
                        <div className="row">
                            ...
                            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                <div className="course__item white-bg mb-30 fix">
                                    <div className="course__thumb w-img p-relative fix">
                                        <Link href="/course-details"><img src="assets/img/course/course-7.jpg" alt="img not found" /></Link>
                                        <div className="course__tag">
                                    ...
                                    <div className="course__content">
                                        ...
                                        <div className="course__teacher d-flex align-items-center">
                                            ...
                                            <h6><Link href="/instructor-details">Sameul Sefif</Link></h6>
                                        </div>
                                    </div >
                                    <div className="course__more d-flex justify-content-between align-items-center">
                                        <div className="course__status d-flex align-items-center">
                            ...
                            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                <div className="course__item white-bg mb-30 fix">
                                    <div className="course__thumb w-img p-relative fix">
                                        <Link href="/course-details"><img src="assets/img/course/course-8.jpg" alt="img not found" /></Link>
                                        <div className="course__tag">
                                            <Link href="/course-details" className="yellow">Marketing</Link>
                                        </div>
                                    </div>
                                    <div className="course__content">
                                        <div className="course__meta d-flex align-items-center justify-content-between">
                            ...
                            <div className="col-xxl-12">
                                <div className="course__item white-bg mb-30 fix">
                                    <div className="row gx-0">
                                        <div className="col-xxl-4 col-xl-4 col-lg-4">
                                            <div className="course__thumb course__thumb-list w-img p-relative fix">
                                                <Link href="/course-details"><img src="assets/img/course/list/course-2.jpg" alt="img not found" /></Link>
                                                <div className="course__tag">
                            ...
                            <div className="col-xxl-12">
                                <div className="course__item white-bg mb-30 fix">
                                    <div className="row gx-0">
                                        <div className="col-xxl-4 col-xl-4 col-lg-4">
                                            <div className="course__thumb course__thumb-list w-img p-relative fix">
                                                <Link href="/course-details"><img src="assets/img/course/list/course-3.jpg" alt="img not found" /></Link>
                                                <div className="course__tag">
                                            ...
                                            <div className="course__right">
                                                <div className="course__content course__content-4">
                                                    ...
                                                    <div className="course__teacher d-flex align-items-center">
                                                        ...
                                                        <h6><Link href="/instructor-details">Elon Tusk</Link></h6>
                                                    </div>
                                                </div>
                                                <div className="course__more course__more-2 course__more-3 d-flex justify-content-between align-items-center">
                                                    <div className="course__status d-flex align-items-center">
                            ...
                            <div className="col-xxl-12">
                                <div className="course__item white-bg mb-30 fix">
                                    <div className="row gx-0">
                                        <div className="col-xxl-4 col-xl-4 col-lg-4">
                                            <div className="course__thumb course__thumb-list w-img p-relative fix">
                                                <Link href="/course-details"><img src="assets/img/course/list/course-4.jpg" alt="img not found" /></Link>
                                                <div className="course__tag">
                            ...
                            <div className="col-xxl-12">
                                <div className="course__item white-bg mb-30 fix">
                                    <div className="row gx-0">
                                        <div className="col-xxl-4 col-xl-4 col-lg-4">
                                            <div className="course__thumb course__thumb-list w-img p-relative fix">
                                                <Link href="/course-details"><img src="assets/img/course/list/course-5.jpg" alt="img not found" /></Link>
                                                <div className="course__tag">
                            ...
                            <div className="col-xxl-12">
                                <div className="course__item white-bg mb-30 fix">
                                    <div className="row gx-0">
                                        <div className="col-xxl-4 col-xl-4 col-lg-4">
                                            <div className="course__thumb course__thumb-list w-img p-relative fix">
                                                <Link href="/course-details"><img src="assets/img/course/list/course-6.jpg" alt="img not found" /></Link>
                                                <div className="course__tag">
