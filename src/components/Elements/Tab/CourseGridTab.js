...
export default () => {
    ...
    useLayoutEffect(() => {
        (async function fetchData() {
            const response = await http.get(`/course/all`).then((response) => {
                setLoading(false);
                            ...
                            <div className="col-xxl-12">
                                <div className="course__tab-conent">
                                    <TabPanel>
                                        <div className="row">
                                            {data.map((item,key) => (
                                                <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6" key={key}>
                                                    <div className="course__item white-bg mb-30 fix">
                                                        <div className="course__thumb w-img p-relative fix">
                                                            ...
                                                            <div className="course__tag">
                                                                <Link href="/course-details">{item.category}</Link>
                                                            </div>
                                                        </div>
                                                        <div className="course__content">
                                                            ...
                                                            <h3 className="course__title"><Link href="/course-details">{item.title}</Link></h3>
                                                            <div className="course__teacher d-flex align-items-center">
                                                                <div className="course__teacher-thumb mr-15">
                                                                    <img src="assets/img/course/teacher/teacher-1.jpg" alt="img not found" />
                                                                </div>
                                                                <h6><Link href="/instructor-details">{item.teacher.fullName}</Link></h6>
                                                            </div>
                                                        </div>
                                    ...
                                    <TabPanel>
                                        <div className="row">
                                            {data.map((item,key) => (
                                                <div className="col-xxl-12" key={key}>
                                                    <div className="course__item white-bg mb-30 fix">
