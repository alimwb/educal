            ...
            <div className="container">
               ...
               <div className="row">
                  <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     <div className="course__item course__item-2 white-bg mb-30 transition-3">
                        <div className="course__thumb fix w-img">
                           <Link href="/course-details"><img src="assets/img/course/home-3/course-1.jpg" alt="img not found" /></Link>
                        </div>
                        <div className="course__content-2">
                           <h3 className="course__title-2"><Link href="/course-details">Product Manager Learn the Skills & job.</Link></h3>
                  ...
                  <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                     <div className="course__item course__item-2 white-bg mb-30 transition-3">
                        <div className="course__thumb fix w-img">
                           <Link href="/course-details"><img src="assets/img/course/home-3/course-2.jpg" alt="img not found" /></Link>
                        </div>
                        <div className="course__content-2">
                           <h3 className="course__title-2"><Link href="/course-details">The Importance Of Intrinsic for Students.</Link></h3>
                           <p>Top instructors from around the world teach millions of students on Quillow. Get unlimited.</p>
                           <div className="course__bottom d-sm-flex justify-content-between align-items-center">
                              <div className="course__teacher-2 d-flex align-items-center">
                                 <div className="course__teacher-thumb-2 mr-20">
                                 ...
                                 <div className="course__teacher-info">
                                    <h6><Link href="/instructor-details">JCraig Weber</Link></h6>
